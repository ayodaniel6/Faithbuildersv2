"""
Django settings for Faithbuilders project.
...
SECRET_KEY = 'django-insecure-zl1s$7y7$vhqo$2e7&4ck*_gcyx5g)irk+r%cfnrb_nwo@-z2_'
...
ROOT_URLCONF = 'Faithbuilders.urls'
...
WSGI_APPLICATION = 'Faithbuilders.wsgi.application'

ASGI_APPLICATION = 'Faithbuilders.asgi.application'
